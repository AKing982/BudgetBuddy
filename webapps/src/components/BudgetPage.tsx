...
const BudgetPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const run = async () => {
            try {
                const anyNew = await transactionCategoryService.checkNewTransactionCategoriesByDateRange(userId, s, e);
                if (anyNew) {
    ...
    useEffect(() => {
        ...
        const run = async () => {
            try {
                const anyUpdated = await transactionCategoryService.checkUpdatedTransactionCategoriesByDateRange(userId, s, e);
                if (anyUpdated) {
                    setIsBudgetCategoryLoading(true);
