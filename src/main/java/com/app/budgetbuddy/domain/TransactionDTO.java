...
public record TransactionDTO(@JsonProperty("accountId") String accountId, @JsonProperty("amount") BigDecimal amount, @JsonProperty("isoCurrencyCode") String isoCurrencyCode, @JsonProperty("categories") List<String> categories, @JsonProperty("categoryId") String categoryId, @JsonProperty("date") String date,
